...
public:
    ...
    static struct Config {
        ...
        /******************************** Tartarini ***************************/
        /* 
         * Forwarding order of the bundles in the deferred list (default FIFO)
         */
        BundleList::sort_order_t bundle_fwd_order_;
        
        /* 
         * Map that contains <keyword - priority> for the bundles that are 
         * waiting to be transmitted
         */
        std::map<std::string,int> prioritymap_;
        /**********************************************************************/
    } config_;
